...
export default function ArticleReader({ article, initialVotes }: ArticleReaderProps) {
  ...
  const leftLabel = article.stanceAxis?.left || stanceAxisDefaults.left;
  const rightLabel = article.stanceAxis?.right || stanceAxisDefaults.right;
  ...
  return (
    <>
      ...
      <div className="w-full max-w-6xl mx-auto px-4 md:px-6 pb-12 select-none">
        {/* Back Button */}
        <div className="mb-6">
          <Link 
            href="/" 
